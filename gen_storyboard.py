...
- Decompose the beat into a natural sequence of scenes — let the material decide the count and the
  lengths (an A1 week runs ~28-34 min of audio). Prefer FEWER, RICHER scenes (each a complete
